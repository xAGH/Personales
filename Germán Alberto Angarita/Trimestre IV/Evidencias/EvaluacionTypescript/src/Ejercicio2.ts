...
export class Promesas {
    promesa1: Promise<number>;

    promesa2: Promise<number>;

    promesa3: Promise<number>;
    ...
    resolver(): void {
        this.promesa1.then((res) => {
            console.log("Respues de la promesa 1: " + (res ** 2));
            return this.promesa2.then((res2) => {
                console.log("Respues de la promesa 2: " + (res2 ** 3));
